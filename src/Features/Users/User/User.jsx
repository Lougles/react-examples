...
import plus from '../../../Shared/svg/plus.svg';
import minus from '../../../Shared/svg/minus.svg';

export const UserItem = ({id, email, first_name, last_name, avatar, onCLickInvite, isInvited }) => (
  <li>
    <div>
    ...
    <img onClick={() => onCLickInvite(id)} className={styles.action} src={isInvited ? minus : plus} alt="Action" />
  </li>
)